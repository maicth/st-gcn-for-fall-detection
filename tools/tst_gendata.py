...
from utils.tst_read_skeleton import read_xyz
...
def gendata(data_path,
    ...
    for filename in os.listdir(data_path):
        ...
        subject_id = int(element_name[0][4:])
        isfall = int(element_name[1] == 'Fall')
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='TST Fall Detection Data Converter.')
    parser.add_argument(
        '--data_path', default='D://AIP490_data//tst_fall_detection_copy')
    parser.add_argument('--out_folder', default='data/tst_fall_detection')
